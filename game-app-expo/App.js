...
import {
  Container, Title, Content, Header, Body, Card, H1, H3, Button
} from 'native-base'
  ...
  const changeItem = (itemNumber) => {
    ...
    if (itemArray[itemNumber] === 'empty') {
      ...
      Alert.alert(
        ...
        "Please select some other position",
      );
      return;
    }
    checkIsWinner();
      ...
      <Content>
        ...
        {winMessage ? (
          <View>
            ...
            <Button onPress={reloadGame} primary block rounded><Text style={{ color: "#FFF" }}>Reload Game</Text></Button>
          </View>) : (
          <View>
